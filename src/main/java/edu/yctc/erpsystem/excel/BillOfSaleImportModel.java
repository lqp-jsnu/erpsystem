 ...
 * @author zzy
 */
public class BillOfSaleImportModel extends BaseRowModel {
    ...
    @ExcelProperty(value = {"出货单信息", "备注"}, index = 7)
    private String remark;

    @ExcelProperty(value = {"出货单信息", "出货仓"}, index = 8)
