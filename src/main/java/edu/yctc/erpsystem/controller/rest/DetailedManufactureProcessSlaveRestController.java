 ...
 * @author smile
 */
public interface DetailedManufactureProcessSlaveRestController {
     ...
     * @return 是否成功
     */
    ResultDO<Void> updateIsIntoMake(ManufactureProcessSlaveDO manufactureProcessSlaveDO);

    /**
     * 通过id对材料库存出库信息新增
     *
     * @param manufactureProcessSlaveDO 制造流程单材料出库视图
     * @param httpSession session
     * @return 是否成功
     */
    ResultDO<Void> updateMaterialExport(DetailedManufactureProcessSlaveVO manufactureProcessSlaveDO, HttpSession httpSession);
