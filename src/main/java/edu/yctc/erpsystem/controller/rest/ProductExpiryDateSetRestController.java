 ...
 * @author qiang
 */
public interface ProductExpiryDateSetRestController {
     ...
     * @return 产品保质期设置链表
     */
    ResultDO<PageUtils<ProductExpiryDateSetVO>> getProductExpiryDateSet(Map<String, Object> params);
     ...
     * 删除
     *
     * @param productExpiryDateSetDO 记录id
     * @return 是否成功
     */
    ResultDO<Void> delete(ProductExpiryDateSetDO productExpiryDateSetDO);
